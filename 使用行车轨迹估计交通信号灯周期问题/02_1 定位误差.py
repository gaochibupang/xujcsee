...
# 读取csv文件
address = r'E:/数据采集与预处理/数据采集与预处理/12_pandas案例/第二次/附件/附件1/A3.csv'  # 改变A1,A2,A3,A4,A5即可
...
# ******************************* 计算红灯时间及周期 （文件01_3）******************
# 读取数据
data = pd.read_csv("E:/数据采集与预处理/数据采集与预处理/12_pandas案例/第二次/代码/02_1_data_time.csv")
